...
export default function HeroSection() {
  return (
    <>
      <div className="">
        <div className="relative isolate px-6  lg:px-8 z-50">
          <div className="mx-auto max-w-2xl pt-20 lg:pt-32 z-50">
            ...
            <div className="text-center">
              ...
              <div className="mt-10 flex items-center justify-center gap-x-6 z-50">
                <a
                  href="#"

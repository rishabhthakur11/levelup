        ...
        <div className="text-center pt-10 sm:pt-12 font-light flex items-center justify-center">
            <form className="flex flex-col justify-center w-3/4 max-w-sm space-y-3 md:flex-row md:w-full md:space-x-3 md:space-y-0 items-center">
                <div className=" relative ">
                    <input type="text" className="w-80 rounded-md p-3 bg-white text-textGray text-semibold focus:outline-none border border-divided" placeholder="Email"/>
                    </div>
                    <button className="flex-shrink-0 px-4 py-2 text-base font-semibold text-white bg-black rounded-lg" type="submit">
                        Subscribe
                    </button>
                </form>
            </div>
